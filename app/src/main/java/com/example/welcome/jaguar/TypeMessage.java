...
public class TypeMessage extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.execSQL("create table if not exists template(msg varchar)");
        ...
        if(MainActivity.msg!=null)
            msg.setText(MainActivity.msg);
        add.setOnClickListener(TypeMessage.this);
    ...
    private void done() {
        ...
        Cursor c1;
        if(ch1.isChecked()) {
            c1 = db.rawQuery("select * from Template where msg='" + msg.getText().toString() + "'", null);
            if(c1.getCount()==0 && !msg.getText().toString().trim().equals(""))
                db.execSQL("insert into template values('" + msg.getText().toString() + "')");
        }
        MainActivity.msg=msg.getText().toString();
        onBackPressed();
        db.close();
    }

    private void choose() {
        final Dialog dialog=new Dialog(TypeMessage.this);
        ...
        Cursor cursor=db.rawQuery("Select * from template",null);
        while(cursor.moveToNext()) {
            dbmsg.add(cursor.getString(0));
        }
        final ArrayAdapter<String> adapter=new ArrayAdapter<String>(TypeMessage.this,android.R.layout.simple_list_item_multiple_choice,dbmsg);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                remove.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        db.execSQL("delete from template where msg='"+dbmsg.get(a)+"'");
                        dialog.dismiss();
                    }
                });
            }
    ...
    private void selColumn() {
        ...
        ArrayAdapter<String> aa=new ArrayAdapter<String>(TypeMessage.this,android.R.layout.simple_list_item_1,arrayList);
        list.setAdapter(aa);
        dialog.show();

...
/**
 * Created by WELCOME on 08-04-2018.
 */
...
public class SimpleFileDialog {
    ...
    {
        public void onChosenDir(String chosenDir,String filename);
    }
                ...
                if (m_SimpleFileDialogListener != null){
                    {
                        ...
                        {
                            m_SimpleFileDialogListener.onChosenDir(m_dir,null);
                        }
                    }
                }
            }
